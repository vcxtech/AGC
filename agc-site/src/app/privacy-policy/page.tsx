            ...
            {[
              {
                ...
                body: "We use secure systems and clear process controls to protect personal information.",
                image: sectionVisualA,
              },
              {
                title: "Transparency",
                body: "This policy explains what data is collected, why, and how you can reach us.",
                image: sectionVisualB,
              },
              {
                title: "Accountability",
                body: "We review and update practices regularly to keep your information safe.",
              ...
              <article key={item.title} className="relative min-h-[210px] overflow-hidden border border-border/80 bg-slate-900">
                ...
                <div className="relative z-10 flex h-full flex-col justify-end p-5 text-white">
                  <p className="text-[0.65rem] font-semibold uppercase tracking-[0.2em] text-white/75">Privacy policy</p>
