...
export const aboutSettingsFormSchema = z.object({
  ...
  strategicContent: z.string().max(10000).optional(),
  strategicPrinciples: z.string().max(10000).optional(),
  strategicAgenda2063: z.string().max(10000).optional(),
